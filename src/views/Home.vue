        ...
        <div class="max-auto  px-8 py-2 bg-white">
         <div class="flex justify-between">
            <div class="logo flex items-center space-x-4 mr-10">
              <img class="h-14" src="https://www.voaxaca.tecnm.mx/wp-content/uploads/2020/05/itvo.ico" alt="">
            ...
            <div class="flex-1 ml-8">
               <div class="w-full inline-flex">
                <input type="text" 
                placeholder="Buscar en sistema" class="w-full rounded-md text-gray-800 bg-gray-100 focus:bg-white 
                focus:outline-none focus:shadow-lg py-3 px-10 max-w-xl text-md focus:text-gray-800" >
                <svg class="h-5  mt-4 px-4  absolute  text-gray-700" xmlns="http://www.w3.org/2000/svg" 
